...
export class RevenueAdjustmentController {
  ...
  async findByRevenueRecordId(
    ...
    return this.adjustmentService.findByRevenueRecordId(
      revenueRecordId,
      clinicId,
    );
  }
  ...
  async getTotalAdjustmentAmount(
    ...
    const total = await this.adjustmentService.getTotalAdjustmentAmount(
      revenueRecordId,
      clinicId,
    );
    return { total };
