...
describe("PointsBalance Entity", () => {
  ...
  describe("創建 PointsBalance 實例", () => {
    ...
    it("應該正確初始化所有欄位", () => {
      ...
      pointsBalance.balance = 500.0;
      pointsBalance.totalEarned = 1000.0;
      pointsBalance.totalRedeemed = 500.0;
      ...
      expect(pointsBalance.balance).toBe(500.0);
      expect(pointsBalance.totalEarned).toBe(1000.0);
      expect(pointsBalance.totalRedeemed).toBe(500.0);
  ...
  describe("點數統計", () => {
    ...
    it("balance 應該等於 totalEarned - totalRedeemed", () => {
      ...
      pointsBalance.balance =
        pointsBalance.totalEarned - pointsBalance.totalRedeemed;
